...
public class PShopItem : MonoBehaviour
{
    ...
    public virtual void applySpecialMove(int moveNum)
    {
        switch (moveNum)
        {
            ...
            case 25: specialMove = "Perfect Hit "; chanceToPierce += 10; piercingDamage = damage; GameLogs.Instance.chanceToPierce += chanceToPierce; GameLogs.Instance.playerPiercingDamage += piercingDamage;
